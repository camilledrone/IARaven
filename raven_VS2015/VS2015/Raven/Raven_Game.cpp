...
#include "armory/Projectile_BombGrenade.h"
...
//------------------------- AddShotGunPellet -----------------------------------
void Raven_Game::AddShotGrenade(Raven_Bot* shooter, Vector2D target)
{
    Raven_Projectile* gd = new BombGrenade(shooter, target);

    m_Projectiles.push_back(gd);
